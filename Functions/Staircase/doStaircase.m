...
stimLevels = num2cell(stairParams.adjustableVarValues(stimIndx));
reversalStimLevel = ones(1,stairParams.maxNumReversals)*NaN;
dataSum = struct(...
    'history',     cell(numStairs, 1), ...
    'response',    cell(numStairs, 1), ...
    'correct',     cell(numStairs, 1), ...
    'trialCounts', cell(numStairs, 1), ...
    'condName',    stairParams.conditionName(conditionIndx), ...
    'stimLevels',  stimLevels, ...
    'numTrials',   num2cell(zeros(1, numLevels)), ...
    'numCorrect',  num2cell(zeros(1, numLevels)), ...
    'etxForm',     cell(numStairs, 1), ...
    'etData',      cell(numStairs, 1), ...
